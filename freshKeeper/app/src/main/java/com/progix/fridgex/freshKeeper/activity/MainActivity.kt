package com.progix.fridgex.freshKeeper.activity
...
import com.progix.fridgex.freshKeeper.R.drawable.ic_baseline_menu_24
import com.progix.fridgex.freshKeeper.application.FreshKeeperApplication.Companion.allHints
import com.progix.fridgex.freshKeeper.application.FreshKeeperApplication.Companion.allProducts
import com.progix.fridgex.freshKeeper.custom.ApplicationBindedActivity
import com.progix.fridgex.freshKeeper.custom.CustomTapTarget
import com.progix.fridgex.freshKeeper.data.DataArrays.fragmentSet
import com.progix.fridgex.freshKeeper.data.DataArrays.mainFragmentIds
import com.progix.fridgex.freshKeeper.data.DataArrays.notNeedToOpenDrawerFragmentIds
import com.progix.fridgex.freshKeeper.data.SharedPreferencesAccess
import com.progix.fridgex.freshKeeper.data.SharedPreferencesAccess.loadFirstStart
import com.progix.fridgex.freshKeeper.data.SharedPreferencesAccess.loadFont
import com.progix.fridgex.freshKeeper.data.SharedPreferencesAccess.loadString
import com.progix.fridgex.freshKeeper.data.SharedPreferencesAccess.loadTheme
import com.progix.fridgex.freshKeeper.data.SharedPreferencesAccess.saveFirstStart
import com.progix.fridgex.freshKeeper.data.SharedPreferencesAccess.saveString
import com.progix.fridgex.freshKeeper.extensions.Extensions.adjustFontSize
import com.progix.fridgex.freshKeeper.extensions.Extensions.dipToPixels
import com.progix.fridgex.freshKeeper.extensions.Extensions.initDataBase
import com.progix.fridgex.freshKeeper.fragment.banned.BannedProductsFragment
import com.progix.fridgex.freshKeeper.fragment.banned.BannedRecipesFragment
...
class MainActivity : ApplicationBindedActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (loadTheme(this)) {
            "def" -> setTheme(R.style.FreshKeeper)
            "red" -> setTheme(R.style.FreshKeeper_Red)
            "pnk" -> setTheme(R.style.FreshKeeper_Pink)
            "grn" -> setTheme(R.style.FreshKeeper_Green)
            "vlt" -> setTheme(R.style.FreshKeeper_Violet)
            "yel" -> setTheme(R.style.FreshKeeper_Yellow)
            "mnt" -> setTheme(R.style.FreshKeeper_Mint)
            "ble" -> setTheme(R.style.FreshKeeper_Blue)
        }
